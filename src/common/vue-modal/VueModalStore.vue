...
import { ref } from 'vue'
import VueButton from '../vue-form/VueButton.vue'
import { IconClose, IconExclamationCircle, IconQuestionCircle } from '../icon/icon-antd'
import VueModal from './VueModal.vue'
import { ModalStore } from './vue-modal.store.ts'
      ...
      <div class="modal-store-card">
        ...
        <div class="modal-store-footer">
          <div class="modal-store-actions">
            <VueButton v-if="modal.cancelText" type="reset" class="ml-auto" @click="handleCancel(modal.onCancel, key)">
              {{ modal.cancelText }}
            </VueButton>
            <VueButton
