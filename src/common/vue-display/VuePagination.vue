...
import { IconDoubleLeft, IconDoubleRight, IconLeft, IconRight } from '../icon/icon-antd'
...
<template>
  <div class="vue-pagination">
    ...
    <template v-for="(text, i) in textList" :key="i">
      <div v-if="text === '<<<'" class="pagination-item pagination-item-jump" @click="clickChangePage(page - 5)">
