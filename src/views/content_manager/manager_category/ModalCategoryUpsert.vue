...
import { IconClose } from '@/common/icon/icon-antd'
import { AlertStore } from '@/common/vue-alert/index.ts'
import { InputNumber, InputSelect, InputText, type InputSelectOption } from '@/common/vue-form/index.ts'
import { VueModal } from '@/common/vue-modal/index.ts'
...
import BugDevelopment from '@/views/app_components/BugDevelopment.vue'
  ...
  <VueModal v-model:show="showModal">
    <form @submit.prevent="handleSave">
      <div
        ...
        style="border-bottom: 1px solid var(--color-border); background-color: var(--color-background-elevated)"
      >
